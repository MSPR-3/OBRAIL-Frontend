...
const ENDPOINTS = [
  {
    ...
    method: 'GET',
    path: '/trajets',
    desc: 'Liste paginée et filtrable des trajets',
    params: [
  ...
  },
  {
    ...
    desc: "Détail complet d'un trajet (jointures gare, ligne, opérateur, pays)",
  ...
  },
  {
    ...
    method: 'GET',
    path: '/stats/kpi',
    desc: 'Indicateurs clés agrégés (totaux, moyennes)',
    params: [],
    example: API_EXAMPLES.kpi,
  },
  {
    id: 'volumes',
    method: 'GET',
    path: '/stats/volumes',
    desc: 'Volumes agrégés selon une dimension',
    params: [
      [
        'groupby',
        'enum',
        'oui',
        '`operateur` | `ligne` | `pays_depart` | `pays_arrivee` | `jour_nuit`',
      ],
    ],
  ...
  },
  {
    id: 'comparatif',
    method: 'GET',
    path: '/stats/comparatif-jour-nuit',
    desc: 'Comparaison jour vs nuit (durée, CO₂)',
    params: [],
    example: API_EXAMPLES.comparatif,
  },
  {
    id: 'co2',
    method: 'GET',
    path: '/stats/co2',
    desc: 'Détail des émissions CO₂',
    params: [],
    example: {
      co2_total_kg: 612.4,
      co2_moyen_kg_par_trajet: 10.21,
      par_operateur: [{ id_operateur: 'OP-SNCF', nom: 'SNCF', co2_total_kg: 130.5 }],
    },
  },
  {
    id: 'top',
    method: 'GET',
    path: '/stats/top-liaisons',
    desc: 'Liaisons les plus fréquentes (groupby gare_depart + gare_arrivee)',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/operateurs',
    desc: 'Liste des opérateurs avec compteurs',
    params: [],
    example: API_EXAMPLES.operateurs,
  },
  {
    id: 'lignes',
    method: 'GET',
    path: '/lignes',
    desc: 'Liste des lignes avec stats',
    params: [
      ['id_operateur', 'string', 'non', 'Filtre par opérateur'],
  ...
  },
  {
    ...
    method: 'GET',
    path: '/gares',
    desc: 'Liste des gares (avec lat/lng pour affichage carte)',
    params: [
  ...
  },
  {
    ...
    method: 'GET',
    path: '/pays',
    desc: 'Liste des pays présents en base',
    params: [],
    example: API_EXAMPLES.pays,
  },
  {
    id: 'imports',
    method: 'GET',
    path: '/imports',
    desc: 'Historique des imports (table historique_import)',
    params: [
  ...
  },
  {
    ...
    method: 'GET',
    path: '/imports/stats',
    desc: 'Statistiques sur les imports',
    params: [],
    example: API_EXAMPLES.importsStats,
  },
  {
    id: 'health',
    method: 'GET',
    path: '/health',
    desc: 'Healthcheck (sans authentification)',
    params: [],
    example: API_EXAMPLES.health,
  },
];
